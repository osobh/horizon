//! Simple evolution benchmark to test our CUDA fix
...
fn main() -> anyhow::Result<()> {
    println!("🧬 Simple GPU Evolution Benchmark");
    println!("==================================");
    ...
    let test_sizes = vec![1024, 2048, 4096];
    let generations = 10;
    ...
    println!("\n✅ Simple evolution benchmark completed!");
    Ok(())
}
...
fn test_evolution_performance(
    ...
    for gen in 0..generations {
        ...
        if gen % 5 == 0 {
            ...
            println!(
                "    Gen {}: best={:.4}, avg={:.4}",
                gen, stats.best_fitness, stats.average_fitness
            );
        }
    }
