...
pub fn create_router(state: Arc<AppState>) -> Router {
    Router::new()
        ...
        .route(
            "/api/v1/finance/costs/breakdown",
            get(handlers::get_cost_breakdown),
        )
        // Finance - Budgets
        ...
        .route(
            ...
            post(handlers::generate_chargeback_report),
        )
        .route(
            "/api/v1/finance/chargeback/reports",
            get(handlers::get_chargeback_reports),
        )
        .route(
            "/api/v1/finance/chargeback/reports/:id",
            get(handlers::get_chargeback_report),
        )
        // Finance - Cost Optimizations
        .route(
            "/api/v1/finance/optimizations",
            get(handlers::get_cost_optimizations),
        )
        .route(
            "/api/v1/finance/optimizations/:id",
            get(handlers::get_cost_optimization),
        )
        .route(
            "/api/v1/finance/optimizations/:id/implement",
            post(handlers::implement_optimization),
        )
        .route(
            "/api/v1/finance/optimizations/:id/reject",
            post(handlers::reject_optimization),
        )
        // Finance - Cost Alerts
        .route("/api/v1/finance/alerts", get(handlers::get_cost_alerts))
        .route("/api/v1/finance/alerts", post(handlers::create_cost_alert))
        .route(
            "/api/v1/finance/alerts/:id/acknowledge",
            post(handlers::acknowledge_cost_alert),
        )
        .route(
            "/api/v1/finance/alerts/:id/resolve",
            post(handlers::resolve_cost_alert),
        )
        .route(
            "/api/v1/finance/alerts/configurations",
            get(handlers::get_alert_configurations),
        )
        .route(
            "/api/v1/finance/alerts/configurations/:id",
            put(handlers::update_alert_configuration),
        )
        ...
        .route(
            ...
            get(handlers::get_daily_trends),
        )
        .route(
            "/api/v1/reports/trends/monthly",
            get(handlers::get_monthly_trends),
        )
        .route(
            "/api/v1/reports/trends/forecast",
