...
impl_consensus_algorithm!(
    FastConsensusAlgorithm,
    ConsensusAlgorithmType::Fast,
    false,
    3,
    100
);
impl_consensus_algorithm!(
    StreamingConsensusAlgorithm,
    ConsensusAlgorithmType::Streaming,
    false,
    10,
    10000
);
impl_consensus_algorithm!(
    GpuNativeConsensusAlgorithm,
    ConsensusAlgorithmType::GpuNative,
    true,
    100,
    1000000
);
impl_consensus_algorithm!(
    MLOptimizedConsensusAlgorithm,
    ConsensusAlgorithmType::MLOptimized,
    true,
    10,
    100000
);
...
impl ConsensusAlgorithm for HybridConsensusAlgorithm {
    ...
    fn min_nodes(&self) -> usize {
        self.primary_algorithm
            .min_nodes()
            .min(self.fallback_algorithm.min_nodes())
    }

    fn max_nodes(&self) -> usize {
        self.primary_algorithm
            .max_nodes()
            .max(self.fallback_algorithm.max_nodes())
    }
